...
export default function AddEmployee() {
    ...
    return (
        <>
            <Button mt={"20px"} boxShadow={"0px 0px 5px grey"} bg={"#D5AD18"} color={"white"} w={{ base: '200px', md: '200px', lg: '200px' }} onClick={onOpen}>Add Cashier</Button>
            <Modal
                ...
                <ModalContent borderRadius={"10px"}>
                    <ModalHeader borderTopRadius={"10px"} bg={"#FFC900"}>Create a New Employee Account</ModalHeader>
                    <ModalCloseButton />
                    <ModalBody pb={6}>
                        <Formik
                                ...
                                return (
                                    <Form>
                                        <FormControl>
                                            ...
                                            <Field as={Input} ref={initialRef} variant={"flushed"} placeholder='Ex: John Doe' name="fullName" borderBottom={"1px solid"} borderColor={"#D5AD18"} />
                                        ...
                                        <FormControl mt={4}>
                                            <DatePickerField label={"Birtdate"} name="birthdate" />
                                            <ErrorMessage
                                                component="box"
                                                name="birthdate"
                                        ...
                                        <FormControl mt={4}>
                                            ...
                                            <Field as={Input} variant={"flushed"} placeholder='Ex: 0872312345726' name='phone' borderBottom={"1px solid"} borderColor={"#D5AD18"} />
                                        ...
                                        <Button type='submit' colorScheme='yellow' mt={"10px"} mr={3}>  Add Cashier  </Button>
